...
class BS_ICS_Block {
	...
	public function register_block() {
		...
		// Alle angelegten Feeds für das Dropdown im Editor auslesen
	...
	/**
	 * Render-Callback für den dynamischen Block (nutzt direkt BS_ICS_Renderer).
	 *
